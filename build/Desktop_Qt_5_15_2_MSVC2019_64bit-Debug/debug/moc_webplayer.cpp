...
QT_MOC_LITERAL(1, 10, 19), // "playPlaylistChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12) // "playPlaylist"

    },
    "WebPlayer\0playPlaylistChanged\0\0"
    "playPlaylist"
};
...
void WebPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playPlaylistChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebPlayer::playPlaylistChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->playPlaylist(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPlayPlaylist(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void WebPlayer::playPlaylistChanged()
{
